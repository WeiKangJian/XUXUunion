...
import com.Activitys.real.PrivateComment;
...
public class ListAdapter3 extends ArrayAdapter<Myfriendinfo>{
	public ListAdapter3(Context context, int resource, List<Myfriendinfo> objects) {
...
//	    	}
	       final  Myfriendinfo teacher = getItem(position);
...
//	        textview2.setText(teacher.getcontent());
	        oneTeacherView.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View v) {
	            	Intent intent = new Intent(getContext(),PrivateComment.class);
	                // 准备跳转
